    ...
    <section class="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Contact Saya</h1>
                       <p>Call us : 0821 6492 0623</p>
                       <p>Email : laura.bolu@yahoo.com</p>
                       <p>Pin BB : 225F07</p> 
                       <p>Medan, 21322. INDONESIA</p> 
                </div>
                <div class="col-lg-2">
                    <h4>Atau</h4>
                    <h4>Input</h4>
                ...
                <div class="col-lg-5 text-box">
                    ...
                    <button class="btn btn-successes" input type="submit" value="submit">Send Message</button>
                </div>
                </form>
                    <?php
    if ($_POST) {
        ...
        echo "<p>Nama : {$nama}</p> <p>Email : {$email}</p> <p>Coment : {$subject}</p>";
    }
?>
            </div>
        </div>
