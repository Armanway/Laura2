...
<!-- header -->
    <div class="header">
        ...
        <div class="jumbotron amanda animated fadeInRightBig">
            <div class="container">
                <h1>Bolu Amanda</h1>
                <p style="width: 860px;margin: auto;font-size: 18px">Bolu Amanda adalah ole ole medan yang khas memiliki bentuk yang indah dan rasa yang sangat enak dan banyak di sukai orang dan sekarang bolo amanda adalah bolu terlejat di medan.</p>
            </div>
            <img src="images/amanda2.jpg" alt="" width="120" height="120" class="img1">
            <img src="images/amanda5.jpg" alt="" width="120" height="120" class="img2">
            <img src="images/amanda6.jpg" alt="" width="120" height="120" class="img3">
            <img src="images/amanda8.jpg" alt="" width="120" height="120">
        </div>
        ...
        <div class="container zulaika top_left_cont flipInY wow animated">
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda1.jpg" alt="bika">
                        <h2>Rp. 45.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda2.jpg" alt="bika">
                        <h2>Rp. 45.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda3.jpg" alt="bika">
                        <h2>Rp. 47.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda4.jpg" alt="bika">
                        <h2>Rp. 50.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda5.jpg" alt="bika">
                        <h2>Rp. 52.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda6.jpg" alt="bika">
                        <h2>Rp. 50.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda7.jpg" alt="bika">
                        <h2>Rp. 55.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/amanda8.jpg" alt="bika">
                        <h2>Rp. 47.000,00</h2>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda greentea">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="47000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda pandan">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda strowberry">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda choconut">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda cheese">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda cheesepandan">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda 3taste">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
