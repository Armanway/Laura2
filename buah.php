        ...
        <div class="container zulaika top_left_cont flipInY wow animated">
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah1.jpg" alt="bika">
                        <h2>Rp. 30.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah2.jpg" alt="bika">
                        <h2>Rp. 40.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah3.jpg" alt="bika">
                        <h2>Rp. 20.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah4.jpg" alt="bika">
                        <h2>Rp. 45.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah5.jpg" alt="bika">
                        <h2>Rp. 53.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah6.jpg" alt="bika">
                        <h2>Rp. 37.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah7.jpg" alt="bika">
                        <h2>Rp. 46.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/buah8.jpg" alt="bika">
                        <h2>Rp. 70.000,00</h2>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: #31b0d5">pemesanan buah</h4>
              </div>
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Strowberry">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="70000">
                    </div>
                </div>
                 <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="strowberry s">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="30000">
                    </div>
                </div>
                 <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="buah kuning">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Markisa">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Lengkeng">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Appel">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="53000">
                    </div>
                </div>
                 <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="cerry">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="37000">
                    </div>
                </div>
                 <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Jeruk">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="46000">
                    </div>
                </div>
                 <div class="form-group">
                    <div class="col-sm-10">
