...
<!-- header -->
    ...
    <div class="jumbotron kopi">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="animated fadeInLeftBig">LEZAT & MENAKJUBKAN</h4>
                        <h1 class="animated fadeInLeftBig">KALIAN HARUS MENCOBA</h1>
                        <h1 class="animated fadeInLeftBig">KOPI INI KARENA INI </h1> 
                        <h1 class="animated fadeInLeftBig">BERHASIAT.</h1>
                        <p class="animated fadeInLeftBig">Seperti yang orang banyak katakan kopi ini mengandung vitamin dan banyak mineral yang mampu membuat tubuh kita segar bugar. Dan jangan lupa kopi ini sangat spesial kali bagi orang spesial</p>
                        <a href="index.html" class="btn btn-infos animated fadeInLeftBig" role="button">LEARN MORE</a>
                    </div>

                    <div class="col-lg-6 img">
                        <a href=""><img src="images/kopi2.png" alt="header" class="top_left_cont flipInY wow animated"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container zulaika top_left_cont flipInY wow animated">
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/kopi1.jpg" alt="bika">
                        <h2>Rp. 30.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/kopi2.jpg" alt="bika">
                        <h2>Rp. 42.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/kopi3.jpg" alt="bika">
                        <h2>Rp. 53.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/kopi4.jpg" alt="bika">
                        <h2>Rp. 40.000,00</h2>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: #31b0d5">pemesanan kopi</h4>
              </div>
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="kopi tampak hijau">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="32000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Kopi tampak coklat">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="kopi arabika">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Kopi tampak 1/2kg">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
