...
<!-- header -->
    ...
    <div class="jumbotron sirup">
        <div class="container">
            <h1>Minuman Sirup</h1>
            <h3 style="padding-top: 20px;color: #fff;">Berkualitas, Mahal, Leza, Dan Sangat Istimewa</h3>
            <p style="width: 800px;margin: 0 auto;color:#fff;">Minuman sirup ini adalah minuman yang lezat dan berkualitas sehingga semua orang ingin membelinya dan minuman ini bisa di konsumsi dengan baik karena membantu pelancaran otak kita minuman sirup ini juga bisa membantu kita juga berpikir.</p>
        </div>

        <img src="images/sirup1.jpg" alt="sirup">
        <img src="images/sirup5.jpg" alt="sirup">
        <img src="images/sirup7.jpg" alt="sirup">
        <img src="images/sirup8.jpg" alt="sirup">
    </div>
        ...
        <div class="container zulaika top_left_cont flipInY wow animated">
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup1.jpg" alt="bika">
                        <h2>Rp. 20.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup2.jpg" alt="bika">
                        <h2>Rp. 24.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup3.jpg" alt="bika">
                        <h2>Rp. 22.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup4.jpg" alt="bika">
                        <h2>Rp. 45.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup5.jpg" alt="bika">
                        <h2>Rp. 40.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup6.jpg" alt="bika">
                        <h2>Rp. 50.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup7.jpg" alt="bika">
                        <h2>Rp. 34.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/sirup8.jpg" alt="bika">
                        <h2>Rp. 44.000,00</h2>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: #31b0d5">pemesanan sirup</h4>
              </div>
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="sirup markisa">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="20000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div class="col-sm-18">
                        <div class="col-lg-2">
                            <div class="checkbox">
                                <label for="">
                                    <input type="radio" value="JNE" name="pengirimaan"><span class="bri">JNE</span>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-2">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Amanda original">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="24000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="situp R">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="22000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="sirup markisa 2">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="kurnia">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="40000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="markisa O/T">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="kurnia O/T">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="34000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="markisa 5">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="44000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div class="col-sm-18">
                        <div class="col-lg-2">
                            <div class="checkbox">
                                <label for="">
                                    <input type="radio" value="JNE" name="pegiriman"><span class="bri">JNE</span>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-2">
