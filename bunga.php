...
require 'koneksi.php';
    ...
    $query-> execute([$produk,$harga,$pengiriman,$nama,$no_tlp,$bank,$no_rekening]);
    if ($query) {
        echo "<script>
        ...
        <div class="container zulaika top_left_cont flipInY wow animated">
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga1.jpg" alt="bika">
                        <h2>Rp. 54.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga2.jpg" alt="bika">
                        <h2>Rp. 30.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga3.jpg" alt="bika">
                        <h2>Rp. 35.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga4.jpg" alt="bika">
                        <h2>Rp. 70.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga5.jpg" alt="bika">
                        <h2>Rp. 56.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga6.jpg" alt="bika">
                        <h2>Rp. 47.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga7.jpg" alt="bika">
                        <h2>Rp. 60.000,00</h2>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="thumbnail">
                        <img src="images/bunga8.jpg" alt="bika">
                        <h2>Rp. 55.000,00</h2>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: #31b0d5">pemesanan bunga</h4>
              </div>
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="produk" value="Kaktus">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="54000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="35000">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10">
        ...
        <div class="modal fade" id="modal6">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="color: #31b0d5">kaktus</h4>
              </div>
              <div class="modal-body">
                <div class="form-group">
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="harga" value="56000">
                    </div>
                </div>
                 <div class="form-group">
                    <div class="col-sm-10">
